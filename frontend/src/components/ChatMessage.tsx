  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        th({ children }) {
          return <th className="bg-gray-50 px-4 py-2 text-left text-sm font-semibold text-gray-700 border border-gray-200">{children}</th>
        },
        td({ children }) {
          return <td className="px-4 py-2 text-sm border border-gray-200 text-gray-800">{children}</td>
        },
      }}
    >
      {content}
